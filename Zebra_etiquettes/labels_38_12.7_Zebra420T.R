...
for (i in 1:length(ind)){
  ...
  # }
  Labels<-ind[i]
  custom_create_PDF(user = FALSE,Labels = Labels,name = paste0(wsr(ind[i])),type = "matrix",ErrCorr = "H",Fsz = 6,Across = FALSE,ERows = 0,ECols = 0,trunc =TRUE,numrow = 1,numcol = 1,page_width = 1.49606,page_height = 0.4724409,width_margin = 0,height_margin = 0,label_width = 1.49606,label_height = 0.4724409,x_space = 0.1,y_space = 0.5)
}